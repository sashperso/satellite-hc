...
This is a health check report for the sat-1 Satellite server conducted on a RedHat 8.7 instance, at 14:06:45 on 2023-01-25.
...
- 20953852 Kilobytes is insufficient for a channel download
...
- '64 bytes from sat-1.gpslab.cbr.redhat.com (10.76.23.10): icmp_seq=1 ttl=64 time=0.102
    ms'
- ''
...
- PING sat-1.gpslab.cbr.redhat.com (10.76.23.10) 56(84) bytes of data.
- '64 bytes from sat-1.gpslab.cbr.redhat.com (10.76.23.10): icmp_seq=1 ttl=64 time=0.088
    ms'
- ''
- '--- sat-1.gpslab.cbr.redhat.com ping statistics ---'
- 1 packets transmitted, 1 received, 0% packet loss, time 0ms
...
- '64 bytes from a23-0-236-83.deploy.static.akamaitechnologies.com (23.0.236.83):
    icmp_seq=1 ttl=54 time=5.11 ms'
- ''
- '--- e4177.cd.akamaiedge.net ping statistics ---'
- 1 packets transmitted, 1 received, 0% packet loss, time 0ms
- rtt min/avg/max/mdev = 5.114/5.114/5.114/0.000 ms
...
"----|------------------------------------------------------|----------------------------|----------|-------------\nID
    \ | NAME                                                 | JOB CATEGORY               |
    PROVIDER | TYPE        \n----|------------------------------------------------------|----------------------------|----------|-------------\n178
    | Ansible Collection - Install from Galaxy             | Ansible Galaxy             |
    Ansible  | job_template\n179 | Ansible Roles - Ansible Default                      |
    Ansible Playbook           | Ansible  | job_template\n180 | Ansible Roles - Install
    from Galaxy                  | Ansible Galaxy             | Ansible  | job_template\n181
    | Ansible Roles - Install from git                     | Ansible Roles Installation
    | Ansible  | job_template\n185 | Ansible - Run insights maintenance plan              |
    Ansible Playbook           | Ansible  | job_template\n191 | Ansible - Run playbook
    \                              | Ansible Playbook           | Ansible  | job_template\n182
    | Capsule Upgrade Playbook                             | Maintenance Operations
    \    | Ansible  | job_template\n206 | Change content source                                |
    Katello                    | SSH      | job_template\n211 | Check Leapp                                          |
    Leapp                      | SSH      | snippet     \n149 | Check Update - SSH
    Default                           | Packages                   | SSH      | job_template\n183
    | Configure Cloud Connector                            | Maintenance Operations
    \    | Ansible  | job_template\n184 | Convert to RHEL                                      |
    Convert 2 RHEL             | Ansible  | job_template\n207 | Install errata by
    search query - Katello SSH Default | Katello                    | SSH      | job_template\n161
    | Install Errata - Katello Ansible Default             | Katello via Ansible        |
    Ansible  | job_template\n160 | Install Errata - Katello SSH Default                 |
    Katello                    | SSH      | job_template\n163 | Install Group - Katello
    Ansible Default              | Katello via Ansible        | Ansible  | job_template\n162
    | Install Group - Katello SSH Default                  | Katello                    |
    SSH      | job_template\n165 | Install Package - Katello Ansible Default            |
    Katello via Ansible        | Ansible  | job_template\n164 | Install Package -
    Katello SSH Default                | Katello                    | SSH      | job_template\n186
    | Module Action - Ansible Default                      | Ansible Modules            |
    Ansible  | job_template\n150 | Module Action - SSH Default                          |
    Modules                    | SSH      | job_template\n187 | Package Action - Ansible
    Default                     | Ansible Packages           | Ansible  | job_template\n151
    | Package Action - SSH Default                         | Packages                   |
    SSH      | job_template\n188 | Power Action - Ansible Default                       |
    Ansible Power              | Ansible  | job_template\n152 | Power Action - SSH
    Default                           | Power                      | SSH      | job_template\n153
    | Puppet Agent Disable - SSH Default                   | Puppet                     |
    SSH      | job_template\n154 | Puppet Agent Enable - SSH Default                    |
    Puppet                     | SSH      | job_template\n155 | Puppet Module - Install
    from forge - SSH Default     | Puppet                     | SSH      | job_template\n156
    | Puppet Module - Install from git - SSH Default       | Puppet                     |
    SSH      | job_template\n189 | Puppet Run Once - Ansible Default                    |
    Ansible Puppet             | Ansible  | job_template\n157 | Puppet Run Once -
    SSH Default                        | Puppet                     | SSH      | job_template\n167
    | Remove Group - Katello Ansible Default               | Katello via Ansible        |
    Ansible  | job_template\n166 | Remove Group - Katello SSH Default                   |
    Katello                    | SSH      | job_template\n169 | Remove Package - Katello
    Ansible Default             | Katello via Ansible        | Ansible  | job_template\n168
    | Remove Package - Katello SSH Default                 | Katello                    |
    SSH      | job_template\n209 | Resolve Traces - Katello Ansible Default             |
    Katello via Ansible        | Ansible  | job_template\n208 | Resolve Traces - Katello
    SSH Default                 | Katello                    | SSH      | job_template\n171
    | Restart Services - Katello Ansible Default           | Katello via Ansible        |
    Ansible  | job_template\n170 | Restart Services - Katello SSH Default               |
    Katello                    | SSH      | job_template\n205 | Run a playbook downloaded
    from RH cloud              | Red Hat Insights           | Ansible  | job_template\n190
    | Run Command - Ansible Default                        | Ansible Commands           |
    Ansible  | job_template\n158 | Run Command - SSH Default                            |
    Commands                   | SSH      | job_template\n176 | Run OpenSCAP scans
    \                                  | OpenSCAP                   | SSH      | job_template\n210
    | Run OpenSCAP scans - Ansible Default                 | OpenSCAP Ansible Commands
    \ | Ansible  | job_template\n177 | Run OVAL scans                                       |
    OpenSCAP                   | SSH      | job_template\n212 | Run preupgrade via
    Leapp                             | Leapp - Preupgrade         | SSH      | job_template\n213
    | Run remediation plan via Leapp                       | Other                      |
    SSH      | job_template\n148 | Run remediations based on Insights recommendations
    \  | Red Hat Insights           | Ansible  | job_template\n214 | Run upgrade via
    Leapp                                | Leapp - Upgrade            | Ansible  |
    job_template\n192 | Service Action - Ansible Default                     | Ansible
    Services           | Ansible  | job_template\n193 | Service Action - Enable Web
    Console                  | Ansible Services           | Ansible  | job_template\n159
    | Service Action - SSH Default                         | Services                   |
    SSH      | job_template\n173 | Update Group - Katello Ansible Default               |
    Katello via Ansible        | Ansible  | job_template\n172 | Update Group - Katello
    SSH Default                   | Katello                    | SSH      | job_template\n175
    | Update Package - Katello Ansible Default             | Katello via Ansible        |
    Ansible  | job_template\n174 | Update Package - Katello SSH Default                 |
    Katello                    | SSH      | job_template\n----|------------------------------------------------------|----------------------------|----------|-------------"
