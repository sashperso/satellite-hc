...
This is a health check report for the sat-1 Satellite server conducted on a RedHat 8.7 instance, at 14:21:30 on 2023-01-25.
...
- 20953196 Kilobytes is insufficient for a channel download
...
- '64 bytes from sat-1.gpslab.cbr.redhat.com (10.76.23.10): icmp_seq=1 ttl=64 time=0.124
    ms'
- ''
...
- '64 bytes from a23-0-236-83.deploy.static.akamaitechnologies.com (23.0.236.83):
    icmp_seq=1 ttl=54 time=5.25 ms'
- ''
- '--- e4177.cd.akamaiedge.net ping statistics ---'
- 1 packets transmitted, 1 received, 0% packet loss, time 0ms
- rtt min/avg/max/mdev = 5.251/5.251/5.251/0.000 ms
