...
+ journalctl --priority=err --unit foreman* --unit httpd --unit postgresql --unit pulp* --unit redis --unit tomcat
----
{{ shc_log_sat_services.stdout_lines }}
----

+ zgrep -P -e '\[[EF]\|' /var/log/foreman/production.log*
----
{{ shc_log_foreman_production.stdout_lines }}
----
